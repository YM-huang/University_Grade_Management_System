                        ...
                        <div class="sparkline8-list shadow-reset">
                            ...
                            <div class="sparkline8-graph">
                                <div class="datatable-dashv1-list custom-datatable-overright">
                                    <div>
                                        <form action="FuzzyQueryStuInfo" method="post" style="position:relative;float:left;">
                                            <span style="color: #fff">请输入姓名、学号、班级（支持模糊查询）：</span>
                                    ...
                                    <br>
                                    <div>
                                        <form action="addStuInfo.jsp" method="post" style="position:relative;float:left;">
                                            <input type="submit" class="btn btn-primary btn-sm" style="border-radius: 5px;width: 80px;" value="添加学生">
                                        </form>
                                    </div>
                                    <br>
                                    <br>
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true" data-cookie-id-table="saveId" data-show-export="true" data-click-to-select="true" data-toolbar="#toolbar">
                                        ...
                                        <tr>
                                            ...
                                            <th data-field="address" data-editable="true">生源地</th>
                                            <th data-field="op">操作</th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        <c:forEach var="stuInfos" items="${sessionScope.stuInfos}" varStatus="status">
                                            <tr>
                                                <td></td>
                                                <td>${stuInfos.lpy_Sno15}</td>
                                                <td>${stuInfos.lpy_Sname15}</td>
                                                <td>${stuInfos.lpy_Sclass15}</td>
                                                <td>${stuInfos.lpy_Smajor15}</td>
                                                <td>${stuInfos.lpy_Scollege15}</td>
                                                <td>${stuInfos.lpy_Ssex15}</td>
                                                <td>${stuInfos.lpy_Sage15}</td>
                                                <td>${stuInfos.lpy_Sphone15}</td>
                                                <td>${stuInfos.lpy_Shometown15}</td>
                                                <td>
                                                    <div class="btn-group project-list-action">
                                                        <a href="AdStuInfoChange?no=${stuInfos.lpy_Sno15}"><button class="btn btn-white btn-action btn-xs"><i class="fa fa-folder"></i> 修改</button></a>
                                                        <a href="StuInfoDelete?no=${stuInfos.lpy_Sno15}"><button class="btn btn-white btn-xs"><i class="fa fa-pencil"></i> 删除</button></a>
                                                    </div>
                                                </td>
                                            </tr>
                                        </c:forEach>

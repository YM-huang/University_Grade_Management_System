                        ...
                        <div class="sparkline8-list shadow-reset">
                            ...
                            <div class="sparkline8-graph">
                                <div class="datatable-dashv1-list custom-datatable-overright">
                                    <div>
                                        <form action="FuzzyQueryStuCredit" method="post" style="position:relative;float:left;">
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true" data-cookie-id-table="saveId" data-show-export="true" data-click-to-select="true" data-toolbar="#toolbar">
                                        ...
                                        <tr>
                                            ...
                                            <th data-field="credit" data-editable="true">已修总学分</th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        <c:forEach var="students" items="${sessionScope.students}" varStatus="status">
                                            <tr>
                                                <td></td>
                                                <td>${students.lpy_Sno15}</td>
                                                <td>${students.lpy_Sname15}</td>
                                                <td>${students.lpy_Scredit15}</td>
                                            </tr>
                                        </c:forEach>
                                        </tbody>
                                    </table>

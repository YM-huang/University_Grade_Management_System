...
<%
    ...
    String classno= (String) request.getSession().getAttribute("classno");
    ...
    request.getSession().setAttribute("classno9",classno);
    request.getSession().setAttribute("classname9",classname);
    request.getSession().setAttribute("courseno9",courseno);
    request.getSession().setAttribute("coursename9",coursename);
    if(teachers==null){
        ...
        <div class="login-form-area mg-t-30 mg-b-40">
            <div class="container-fluid">
                <div class="row">
                    ...
                    <form id="adminpro-form" class="adminpro-form" action="ChangeClassCourse" method="post" onsubmit="return custCheck()">
                        <div class="col-lg-5">
                            <div class="login-bg">
                                <div class="row">
                                    <div class="col-lg-12">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="login-input-area">
                                            <input type="text" name="classno" id="classno" value="${classno}">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="login-input-area">
                                            <input type="text" name="courseno" id="courseno" value="${courseno}">
                                            <i class="fa fa-lock login-user"></i>
                                        </div>
                                    </div>
                                </div>

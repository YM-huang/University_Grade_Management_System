                        ...
                        <div class="sparkline8-list shadow-reset">
                            ...
                            <div class="sparkline8-graph">
                                <div class="datatable-dashv1-list custom-datatable-overright">
                                    <div>
                                        <form action="FuzzyQueryTeaCourse" method="post" style="position:relative;float:left;">
                                            <span style="color: #fff">请输入工号、姓名、课程编号、课程名、学期、考核方式（支持模糊查询）：</span>
                                    ...
                                    <br>
                                    <div>
                                        <form action="addCourseInfo.jsp" method="post" style="position:relative;float:left;">
                                            <input type="submit" class="btn btn-primary btn-sm" style="border-radius: 5px;width: 120px;" value="添加教师任课">
                                        </form>
                                    </div>
                                    <br>
                                    <br>
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true" data-cookie-id-table="saveId" data-show-export="true" data-click-to-select="true" data-toolbar="#toolbar">
                                        ...
                                        <tr>
                                            ...
                                            <th data-field="courseno" data-editable="true">课程号</th>
                                            <th data-field="coursename" data-editable="true">课程编名</th>
                                            <th data-field="credit" data-editable="true">学分</th>
                                            <th data-field="hour" data-editable="true">学时</th>
                                            <th data-field="term" data-editable="true">开设学期</th>
                                            <th data-field="method" data-editable="true">考核方式</th>
                                            <th data-field="op">操作</th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        <c:forEach var="courses" items="${sessionScope.courses}" varStatus="status">
                                            <tr>
                                                <td></td>
                                                <td>${courses.lpy_Tno15}</td>
                                                <td>${courses.lpy_Tname15}</td>
                                                <td>${courses.lpy_Courseno15}</td>
                                                <td>${courses.lpy_Coursename15}</td>
                                                <td>${courses.lpy_Ccredit15}</td>
                                                <td>${courses.lpy_Chours15}</td>
                                                <td>${courses.lpy_Cterm15}</td>
                                                <td>${courses.lpy_Assessmentmethod15}</td>
                                                <td>
                                                    <div class="btn-group project-list-action">
                                                        <a href="CourseChange?tno=${courses.lpy_Tno15}&tname=${courses.lpy_Tname15}&courseno=${courses.lpy_Courseno15}&coursename=${courses.lpy_Coursename15}&credit=${courses.lpy_Ccredit15}&hour=${courses.lpy_Chours15}&term=${courses.lpy_Cterm15}&method=${courses.lpy_Assessmentmethod15}"><button class="btn btn-white btn-action btn-xs"><i class="fa fa-folder"></i> 修改</button></a>
                                                        <a href="CourseDelete?tno=${courses.lpy_Tno15}&tname=${courses.lpy_Tname15}&courseno=${courses.lpy_Courseno15}&coursename=${courses.lpy_Coursename15}&credit=${courses.lpy_Ccredit15}&hour=${courses.lpy_Chours15}&term=${courses.lpy_Cterm15}&method=${courses.lpy_Assessmentmethod15}"><button class="btn btn-white btn-xs"><i class="fa fa-pencil"></i> 删除</button></a>
                                                    </div>
                                                </td>
                                            </tr>
                                        </c:forEach>

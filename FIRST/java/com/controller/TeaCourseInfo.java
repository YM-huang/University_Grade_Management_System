...
@WebServlet(name = "TeaCourseInfo", value = "/TeaCourseInfo")
public class TeaCourseInfo extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            teaCourses=dao.findByFuzzyTeaCourse(teachers.getLpy_Tno15());

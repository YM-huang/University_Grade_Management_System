        ...
        <div class="login-form-area mg-t-30 mg-b-40">
            <div class="container-fluid">
                <div class="row">
                    ...
                    <form id="adminpro-form" class="adminpro-form" action="StuInfoChange" method="post" onsubmit="return custCheck()">
                        <div class="col-lg-5">
                            <div class="login-bg">
                                <div class="row">
                                    <div class="col-lg-12">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="login-input-area">
                                            <input type="text" name="no" id="no" value="${students.lpy_Sno15}" readonly>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="login-input-area">
                                            <input type="text" name="name" id="name" value="${students.lpy_Sname15}">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="login-input-area">
                                            <input type="text" name="sex" id="sex" value="${students.lpy_Ssex15}">
                                            <i class="fa fa-lock login-user"></i>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="login-input-area">
                                            <input type="text" name="age" id="age" value="${students.lpy_Sage15}">
                                            <i class="fa fa-lock login-user"></i>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="login-input-area">
                                            <input type="text" name="phone" id="phone" value="${students.lpy_Sphone15}">
                                            <i class="fa fa-lock login-user"></i>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="login-input-area">
                                            <input type="text" name="address" id="address" value="${students.lpy_Shometown15}">
                                            <i class="fa fa-lock login-user"></i>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="login-button-pro" style="position:relative;left: 30%;">
                                            <button type="submit" class="login-button login-button-lg" style="width: 150px;">保存</button>
                                        </div>
                                    </div>
                                </div>
                            </div>

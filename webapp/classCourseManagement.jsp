                        ...
                        <div class="sparkline8-list shadow-reset">
                            ...
                            <div class="sparkline8-graph">
                                <div class="datatable-dashv1-list custom-datatable-overright">
                                    <div>
                                        <form action="FuzzyQueryClassCourse" method="post" style="position:relative;float:left;">
                                            <span style="color: #fff">请输入班级号、班级名、课程号、课程名、开设学期、考核方式（支持模糊查询）：</span>
                                    ...
                                    <br>
                                    <div>
                                        <form action="addClassCourseInfo.jsp" method="post" style="position:relative;float:left;">
                                            <input type="submit" class="btn btn-primary btn-sm" style="border-radius: 5px;width: 120px;" value="添加班级课程开设">
                                        </form>
                                    </div>
                                    <br>
                                    <br>
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true" data-cookie-id-table="saveId" data-show-export="true" data-click-to-select="true" data-toolbar="#toolbar">
                                        ...
                                        <tbody>
                                        <c:forEach var="classCourses" items="${sessionScope.classCourses}" varStatus="status">
                                            <tr>
                                                <td></td>
                                                <td>${classCourses.lpy_Classno15}</td>
                                                <td>${classCourses.lpy_Classname15}</td>
                                                <td>${classCourses.lpy_Courseno15}</td>
                                                <td>${classCourses.lpy_Coursename15}</td>
                                                <td>${classCourses.lpy_Ccredit15}</td>
                                                <td>${classCourses.lpy_Chours15}</td>
                                                <td>${classCourses.lpy_Cterm15}</td>
                                                <td>${classCourses.lpy_Assessmentmethod15}</td>
                                                <td>
                                                    <div class="btn-group project-list-action">
                                                        <a href="ClassCourseChange?classno=${classCourses.lpy_Classno15}&classname=${classCourses.lpy_Classname15}&courseno=${classCourses.lpy_Courseno15}&coursename=${classCourses.lpy_Coursename15}"><button class="btn btn-white btn-action btn-xs"><i class="fa fa-folder"></i> 修改</button></a>
                                                        <a href="ClassCourseDelete?classno=${classCourses.lpy_Classno15}&classname=${classCourses.lpy_Classname15}&courseno=${classCourses.lpy_Courseno15}&coursename=${classCourses.lpy_Coursename15}"><button class="btn btn-white btn-xs"><i class="fa fa-pencil"></i> 删除</button></a>
                                                    </div>
                                                </td>
                                            </tr>
                                        </c:forEach>

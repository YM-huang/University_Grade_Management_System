                                    ...
                                    <script type="text/javascript">
                                        ...
                                        option = {
                                            ...
                                            legend: {
                                                ...
                                                left: 200,
                                                data: [
                                                    <c:forEach var="stuAddresses" items="${sessionScope.stuAddresses}" varStatus="status">
                                                    ["${stuAddresses.lpy_Shometown15}"],
                                                    </c:forEach>
                                                ],
                                                textStyle: {
                                                    color: '#ffffff'
                                            ...
                                            series: [
                                                {
                                                    ...
                                                    data: [
                                                        <c:forEach var="stuAddresses" items="${sessionScope.stuAddresses}" varStatus="status">
                                                        {value: ${stuAddresses.lpy_Num15}, name: '${stuAddresses.lpy_Shometown15}'},
                                                        </c:forEach>
                                                    ],
                                                    emphasis: {
                                                        itemStyle: {

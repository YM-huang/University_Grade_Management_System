                        ...
                        <div class="sparkline8-list shadow-reset">
                            ...
                            <div class="sparkline8-graph">
                                <div class="datatable-dashv1-list custom-datatable-overright">
                                    <div>
                                        <form action="FuzzyQueryTeaPersonalCourses" method="post" style="position:relative;float:left;">
                                            <span style="color: #fff">请输入课程编号、课程名、班级编号、班级名（支持模糊查询）：</span>
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true" data-cookie-id-table="saveId" data-show-export="true" data-click-to-select="true" data-toolbar="#toolbar">
                                        ...
                                        <c:forEach var="teaCourses" items="${sessionScope.teaCourses}" varStatus="status">
                                            <tr>
                                                <td></td>
                                                <td>${teaCourses.lpy_Tno15}</td>
                                                <td>${teaCourses.lpy_Tname15}</td>
                                                <td>${teaCourses.lpy_Courseno15}</td>
                                                <td>${teaCourses.lpy_Coursename15}</td>
                                                <td>${teaCourses.lpy_Classno15}</td>
                                                <td>${teaCourses.lpy_Classname15}</td>
                                            </tr>
                                        </c:forEach>
                                        </tbody>
                                    </table>

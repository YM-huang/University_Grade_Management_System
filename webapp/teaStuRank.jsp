                        ...
                        <div class="sparkline8-list shadow-reset">
                            ...
                            <div class="sparkline8-graph">
                                <div class="datatable-dashv1-list custom-datatable-overright">
                                    <div>
                                        <form action="FindTeaStuCourseRank" method="post" style="position:relative;float:left;">
                                            <select name="name" id="name" style="width: 320px;height: 35px;">
                                                <c:forEach var="teaCourses" items="${sessionScope.teaCourses}" varStatus="status">
                                                    <option value=${teaCourses.lpy_Coursename15}>${teaCourses.lpy_Coursename15}</option>
                                                </c:forEach>
                                            </select>
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true" data-cookie-id-table="saveId" data-show-export="true" data-click-to-select="true" data-toolbar="#toolbar">
                                        ...
                                        <tr>
                                            ...
                                            <th data-field="no" data-editable="true">学号</th>
                                            ...
                                            <th data-field="score" data-editable="true">成绩</th>
                                            <th data-field="rank" data-editable="true">排名</th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        <c:forEach var="stuCourseRanks" items="${sessionScope.stuCourseRanks}" varStatus="status">
                                            <tr>
                                                <td></td>
                                                <td>${stuCourseRanks.lpy_Sno15}</td>
                                                <td>${stuCourseRanks.lpy_Sname15}</td>
                                                <td>${stuCourseRanks.lpy_Courseno15}</td>
                                                <td>${stuCourseRanks.lpy_Coursename15}</td>
                                                <td>${stuCourseRanks.lpy_Grade15}</td>
                                                <td>${stuCourseRanks.lpy_Rank15}</td>
                                            </tr>
                                        </c:forEach>
                                        </tbody>
                                    </table>

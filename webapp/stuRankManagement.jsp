                        ...
                        <div class="sparkline8-list shadow-reset">
                            ...
                            <div class="sparkline8-graph">
                                <div class="datatable-dashv1-list custom-datatable-overright">
                                    <div>
                                        <form action="FuzzyQueryStuRank" method="post" style="position:relative;float:left;">
                                            <span style="color: #fff">请输入姓名、学号（支持模糊查询）：</span>
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true" data-cookie-id-table="saveId" data-show-export="true" data-click-to-select="true" data-toolbar="#toolbar">
                                        ...
                                        <tr>
                                            ...
                                            <th data-field="gpa" data-editable="true">平均学分绩点</th>
                                            <th data-field="rank" data-editable="true">排名</th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        <c:forEach var="stuRanks" items="${sessionScope.stuRanks}" varStatus="status">
                                            <tr>
                                                <td></td>
                                                <td>${stuRanks.lpy_Sno15}</td>
                                                <td>${stuRanks.lpy_Sname15}</td>
                                                <td>${stuRanks.lpy_AvgGpa15}</td>
                                                <td>${stuRanks.lpy_Rank15}</td>
                                            </tr>
                                        </c:forEach>
                                        </tbody>
                                    </table>

                        ...
                        <div class="sparkline8-list shadow-reset">
                            ...
                            <div class="sparkline8-graph">
                                <div class="datatable-dashv1-list custom-datatable-overright">
                                    <div>
                                        <form action="StuTermCourse" method="post" style="position:relative;float:left;">
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true" data-cookie-id-table="saveId" data-show-export="true" data-click-to-select="true" data-toolbar="#toolbar">
                                        ...
                                        <tr>
                                            ...
                                            <th data-field="classno" data-editable="true">班级编号</th>
                                            <th data-field="classname" data-editable="true">班级名</th>
                                            <th data-field="courseno" data-editable="true">课程编号</th>
                                            ...
                                            <th data-field="tea" data-editable="true">教师</th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        <c:forEach var="stuCourses" items="${sessionScope.stuCourses}" varStatus="status">
                                            <tr>
                                                <td></td>
                                                <td>${stuCourses.lpy_Sno15}</td>
                                                <td>${stuCourses.lpy_Sname15}</td>
                                                <td>${stuCourses.lpy_Classno15}</td>
                                                <td>${stuCourses.lpy_Classname15}</td>
                                                <td>${stuCourses.lpy_Courseno15}</td>
                                                <td>${stuCourses.lpy_Coursename15}</td>
                                                <td>${stuCourses.lpy_Ccredit15}</td>
                                                <td>${stuCourses.lpy_Chours15}</td>
                                                <td>${stuCourses.lpy_Cterm15}</td>
                                                <td>${stuCourses.lpy_Tname15}</td>
                                            </tr>
                                        </c:forEach>
                                        </tbody>
                                    </table>

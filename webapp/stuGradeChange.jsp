        ...
        <div class="login-form-area mg-t-30 mg-b-40">
            <div class="container-fluid">
                <div class="row">
                    ...
                    <form id="adminpro-form" class="adminpro-form" action="ChangeStuGrade" method="post" onsubmit="return custCheck()">
                        <div class="col-lg-5">
                            <div class="login-bg">
                                <div class="row">
                                    <div class="col-lg-12">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="login-input-area">
                                            <input type="text" name="no" id="no" value="${stuGradeInfo.lpy_Sno15}" readonly>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="login-input-area">
                                            <input type="text" name="courseno" id="courseno" value="${stuGradeInfo.lpy_Courseno15}" readonly>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="login-input-area">
                                            <input type="text" name="grade" id="grade" value="${stuGradeInfo.lpy_Grade15}">
                                            <i class="fa fa-lock login-user"></i>
                                        </div>
                                    </div>
                                </div>

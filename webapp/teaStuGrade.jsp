                        ...
                        <div class="sparkline8-list shadow-reset">
                            ...
                            <div class="sparkline8-graph">
                                <div class="datatable-dashv1-list custom-datatable-overright">
                                    <div>
                                        <form action="FuzzyQueryStuGrade" method="post" style="position:relative;float:left;">
                                            <span style="color: #fff">请输入姓名、学号、课程（支持模糊查询）：</span>
                                    ...
                                    <br>
                                    <div>
                                        <form action="TeaStuTermGrade" method="post" style="position:relative;float:left;">
                                    ...
                                    <br>
                                    <div>
                                        <form action="addStuGrade.jsp" method="post" style="position:relative;float:left;">
                                            <input type="submit" class="btn btn-primary btn-sm" style="border-radius: 5px;width: 120px;" value="添加学生成绩">
                                        </form>
                                    </div>
                                    <br>
                                    <br>
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true" data-cookie-id-table="saveId" data-show-export="true" data-click-to-select="true" data-toolbar="#toolbar">
                                        ...
                                        <tr>
                                            ...
                                            <th data-field="course" data-editable="true">课程名</th>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-group project-list-action">
                                                        <a href="TeaStuGradeChange?no=${stuGradeInfos.lpy_Sno15}&name=${stuGradeInfos.lpy_Coursename15}"><button class="btn btn-white btn-action btn-xs"><i class="fa fa-folder"></i> 修改</button></a>
                                                        <a href="TeaStuGradeDelete?no=${stuGradeInfos.lpy_Sno15}&name=${stuGradeInfos.lpy_Coursename15}"><button class="btn btn-white btn-xs"><i class="fa fa-pencil"></i> 删除</button></a>
                                                    </div>
                                                </td>
                                            </tr>
                                        </c:forEach>
